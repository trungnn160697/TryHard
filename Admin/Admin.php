<?php
  ...
  $user = $result[0];
  $sotailieu = getSQLData('SELECT count(mstl) count FROM tailieu')[0]['count'];
  $luottai = getSQLData('SELECT sum(luottai) sum FROM tailieu')[0]['sum'];
  $sothanhvien = getSQLData('SELECT count(username) count FROM _user')[0]['count'];
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="../" class="logo">
          ...
          <span class="logo-lg"><b>BYGTRYM.ML</b></span>
        </a>
          ...
          <div class="row">
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-aqua">
                ...
                <a href="quanlitailieu.php" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
            <div class="col-lg-3 col-xs-6">
              <!-- small box -->
            ...
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-yellow">
                <div class="inner">
                  <h3><?php echo($sothanhvien)?></h3>
                  <p>Thành viên</p>
                </div>
                <div class="icon">
                  <i class="ion ion-person-add"></i>
                </div>
                <a href="quanlinguoidung.php" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
            <div class="col-lg-3 col-xs-6">
              <!-- small box -->
            ...
            <section class="col-lg-7 connectedSortable">
              ...
              <div class="nav-tabs-custom">
                ...
                <ul class="nav nav-tabs pull-right">
                  ...
                  <li class="pull-left header"><i class="fa fa-inbox"></i> Số lượng truy cập</li>
                </ul>
                ...
                <div class="box-body">
                  <form action="#" method="post">
                    <div class="form-group">
                      <input type="email" id="emailto" class="form-control" name="emailto" placeholder="Email to:" />
                    </div>
                    <div class="form-group">
                      <input type="text" id="mailsubject" class="form-control" name="subject" placeholder="Subject" />
                    </div>
                    <div>
