...
var commentsArray;
var usersArray;
var mstl = window.location.href.split("?id=")[1];
$.ajax({url: 'load-comment.php?usercomment&mstl=' + mstl, success: function(result) {
   // body...
   usersArray = JSON.parse(result);
}});
$.ajax({url: 'load-comment.php?commentcontent&mstl=' + mstl, success: function(result) {
   // body...
   console.log(result);
   commentsArray = JSON.parse(result);
}});
